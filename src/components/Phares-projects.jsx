                        ...
                        >
                            ...
                            <div className="p-8">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className="bg-[#21262D]/50 backdrop-blur-sm border border-[#30363D] hover:border-[#00BFA6]/50 text-[#E6EDF3] hover:text-[#00BFA6] px-5 py-3 rounded-xl transition-all duration-300 flex items-center gap-2 group/btn">
