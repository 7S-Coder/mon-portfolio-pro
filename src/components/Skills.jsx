...
function Skills() {
    ...
    return (
        <section className="py-20 px-6 bg-[#0D1117]" id="skills">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="group bg-gradient-to-br from-[#161B22] to-[#0D1117] rounded-2xl border border-[#21262D] p-8 hover:border-[#00BFA6] transition-all duration-500 hover:shadow-2xl hover:shadow-[#00BFA6]/10">
